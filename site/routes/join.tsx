    ...
    <>
      ...
      <section class="text-white pt-16" style="background-color: #1a5f6e;">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 py-20 text-center">
          ...
          <p class="text-lg max-w-xl mx-auto leading-relaxed" style="color: rgba(255,255,255,0.8);">
      ...
      <section class="py-20 sm:py-24" style="background-color: #f7f4ef;">
        <div class="max-w-4xl mx-auto px-4 sm:px-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8" style="border: 2px solid #c4853a;">
              <div
              ...
              <h2 class="text-xl font-bold mb-2" style="color: #1c1a18;">Join the next meetup</h2>
              <p class="text-sm leading-relaxed mb-6" style="color: rgba(28,26,24,0.7);">
            ...
            <div class="bg-white rounded-2xl p-8" style="border: 1px solid #d0e4e7;">
              <div
                class="w-10 h-10 rounded-lg flex items-center justify-center mb-5 text-white font-bold"
              ...
              <h2 class="text-xl font-bold mb-2" style="color: #1c1a18;">Not sure yet?</h2>
              <p class="text-sm leading-relaxed mb-6" style="color: rgba(28,26,24,0.7);">
      ...
      {/* Reassurance */}
      <section class="py-16" style="background-color: #eef5f7; border-top: 1px solid #d0e4e7;">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <p class="text-lg font-semibold mb-2" style="color: #1c1a18;">What you’re signing up for</p>
          <p style="color: rgba(28,26,24,0.7);" class="max-w-xl mx-auto leading-relaxed">
            A monthly reminder that you’re not alone in thinking about this.
            No spam. No sales. No political agenda. Just honest conversation
