...
const SLIDESHOW_URL =
  "/slideshows/ai-work-and-capitalism-slideshow.html";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="The Future Together meetup slideshow — AI Work and Capitalism."
        />
      </Head>
      ...
      <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="mb-4">
          ...
          <h1
            ...
            style="color: #1a5f6e;"
          >
            AI Work and Capitalism — Meetup Slideshow
          </h1>
        </div>
        ...
        <div class="relative rounded-xl overflow-hidden shadow-lg border border-gray-200">
          ...
          <iframe
            src={SLIDESHOW_URL}
            title="AI Work and Capitalism — Meetup Slideshow"
            class="w-full"
