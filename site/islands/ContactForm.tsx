...
export default function ContactForm({
  ...
  description =
    "Tell us about your project and let's explore how Future Together can help accelerate your development process.",
  source,
  class: className = "",
  onSuccess,
  turnstileSiteKey,
        ...
        ? (
          <div class="text-center">
            ...
            <p class="text-gray-600">
              ...
              discuss how Future Together can help with your project.
            </p>
          </div>
        )
        : (
            ...
            <form onSubmit={handleSubmit} class="space-y-4">
              ...
              <div class="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("company_size", e.currentTarget.value)}
                    class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:outline-none focus:ring-2"
                    disabled={status === "loading"}
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("industry", e.currentTarget.value)}
                    class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:outline-none focus:ring-2"
                    disabled={status === "loading"}
                  >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("current_tools", e.currentTarget.value)}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleInputChange("timeline", e.currentTarget.value)}
                  class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:outline-none focus:ring-2"
                  disabled={status === "loading"}
                >
