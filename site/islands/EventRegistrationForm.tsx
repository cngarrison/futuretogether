...
export default function EventRegistrationForm({
		...
		return (
			<div class='bg-yellow-50 border border-yellow-200 rounded-lg p-6'>
				<div class='flex items-start'>
					...
					<div>
						<h3 class='text-lg font-semibold text-yellow-800 mb-2'>Event Full</h3>
						<p class='text-yellow-700'>
							This session has reached capacity. Please check back for the next scheduled event.
						</p>
					</div>
				</div>
			</div>
		...
		return (
			<div class='bg-green-50 border border-green-200 rounded-lg p-6'>
				<div class='flex items-start'>
					...
					<div>
						<h3 class='text-xl font-bold text-green-800 mb-2'>Registration Confirmed!</h3>
						<p class='text-green-700 mb-4'>
							Thank you for registering for{' '}
							{eventTitle}. Check your email for confirmation and calendar invite.
						</p>
	...
	return (
		<div class='bg-white rounded-lg shadow-sm border border-gray-200 p-6'>
			{eventHeadingText && <h2 class={eventHeadingClass}>{eventHeadingText}</h2>}
			...
			<form onSubmit={handleSubmit} class='space-y-4'>
				...
				<div>
					...
					<p class='text-xs text-gray-500 mb-2'>
						Examples: job market changes, community resilience, food security, preparing for uncertainty
					</p>
					<textarea
						value={interests}
