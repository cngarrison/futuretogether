/*!
 * QR Code Generator — qrcode-generator v1.4.4
 * Shared utility for Future Together slideshows.
 *
 * Usage:
 *   <script src="./qrcode.js"><\/script>
 *   <div id="my-qr"></div>
 *   <script>buildQR('https://example.com', 'my-qr');<\/script>
 *
 * buildQR(url, containerId)
 *   url         — the URL to encode
 *   containerId — id of the DOM element to render the SVG into
 */

// ===== qrcode-generator v1.4.4 (minified) =====
var qrcode = function () {
  var t = function (t, r) {
    var e = t,
      n = g[r],
    ...
    f.addData = function (t, r) {
      ...
      f.createSvgTag = function (t, r, e, n) {
        ...
        (t = (o = arguments[0]).cellSize, r = o.margin, e = o.alt, n = o.title),
          t = t || 2,
          r = void 0 === r ? 4 * t : r,
          (e = "string" == typeof e ? { text: e } : e || {}).text = e.text ||
            null,
          e.id = e.text ? e.id || "qrcode-description" : null,
          (n = "string" == typeof n ? { text: n } : n || {}).text = n.text ||
            null,
        ...
        for (
          c = "l" + t + ",0 0," + t + " -" + t + ",0 0,-" + t + "z ",
            ...
            l += n.text
              ...
              : "",
            l += e.text
              ? '<description id="' + y(e.id) + '">' + y(e.text) +
                "</description>"
              : "",
            l +=
  ...
  var r,
    ...
    B = (r = [
      ...
      o.getLostPoint = function (t) {
        ...
        for (n = 0; n < r; n += 1) {
          for (o = 0; o < r - 6; o += 1) {
            t.isDark(n, o) && !t.isDark(n, o + 1) && t.isDark(n, o + 2) &&
              t.isDark(n, o + 3) && t.isDark(n, o + 4) &&
              !t.isDark(n, o + 5) && t.isDark(n, o + 6) && (e += 40);
          }
        }
        for (o = 0; o < r; o += 1) {
          for (n = 0; n < r - 6; n += 1) {
            t.isDark(n, o) && !t.isDark(n + 1, o) && t.isDark(n + 2, o) &&
              t.isDark(n + 3, o) && t.isDark(n + 4, o) &&
              !t.isDark(n + 5, o) && t.isDark(n + 6, o) && (e += 40);
          }
        }
        var g = 0;
        for (o = 0; o < r; o += 1) {
  ...
  var A = function () {
    ...
    L = function (r) {
      var e = c, n = t.stringToBytesFuncs.SJIS;
  ...
  t.stringToBytesFuncs["UTF-8"] = function (t) {
...
/**
 * buildQR(url, containerId)
 * Renders a QR code SVG into the element with the given id.
 */
function buildQR(url, containerId) {
  var qr = qrcode(0, "M");
  qr.addData(url);
  qr.make();
  var el = document.getElementById(containerId);
  if (el) el.innerHTML = qr.createSvgTag({ scalable: true, margin: 1 });
}
